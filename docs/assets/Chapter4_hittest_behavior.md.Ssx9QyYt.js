import{_ as s,o as e,c as t,ag as n}from"./chunks/framework.CbQjVMS6.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Chapter4/hittest_behavior.md","filePath":"Chapter4/hittest_behavior.md","lastUpdated":1710469901000}'),p={name:"Chapter4/hittest_behavior.md"};function i(l,a,r,h,o,c){return e(),t("div",null,[...a[0]||(a[0]=[n(`<h4 id="histtestbehavor有三个属性" tabindex="-1">histTestBehavor有三个属性： <a class="header-anchor" href="#histtestbehavor有三个属性" aria-label="Permalink to &quot;histTestBehavor有三个属性：&quot;">​</a></h4><ol><li>behavior 为 deferToChild 时，hitTestSelf 返回 false，当前组件是否能通过命中测试完全取决于 hitTestChildren 的返回值。也就是说只要有一个子节点通过命中测试，则当前组件便会通过命中测试。</li><li>behavior 为 opaque 时，hitTestSelf 返回 true，hitTarget 值始终为 true，当前组件通过命中测试。</li><li>behavior 为 translucent 时，hitTestSelf 返回 false，hitTarget 值此时取决于 hitTestChildren 的返回值，但是无论 hitTarget 值是什么，当前节点都会被添加到 HitTestResult 中。</li></ol><p>注意，behavior 为 opaque 和 translucent 时当前组件都会通过命中测试，它们的区别是 hitTest() 的返回值（hitTarget ）可能不同，所以它们的区别就看 hitTest() 的返回值会影响什么，这个我们已经在上面详细介绍过了，下面我们通过一个实例来理解一下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//在命中测试过程中 Listener 组件如何表现。</span></span>
