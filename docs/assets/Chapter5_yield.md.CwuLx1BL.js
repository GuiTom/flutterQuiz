import{_ as n,o as s,c as p,ag as e}from"./chunks/framework.FundgpKU.js";const h=JSON.parse('{"title":"第2节：yield","description":"","frontmatter":{},"headers":[],"relativePath":"Chapter5/yield.md","filePath":"Chapter5/yield.md","lastUpdated":1702281941000}'),l={name:"Chapter5/yield.md"};function t(i,a,c,r,d,o){return s(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="第2节-yield" tabindex="-1">第2节：yield <a class="header-anchor" href="#第2节-yield" aria-label="Permalink to &quot;第2节：yield&quot;">​</a></h1><p>yield<code>语句只能用于生成器的函数。 生成器的功能以自然的方式生成数据项（如计算，从外部接收，预定义值等）。 当下一个数据项准备就绪时，</code>yield<code>语句将此项发送到数据序列，该数据序列本质上是函数的生成结果。 数据序列可以是同步的或异步的。 在Dart语言中，同步数据序列表示</code>Iterable<code>的实例。 异步数据序列表示</code>Stream\`的实例。</p><p>1.同步数据生成器: 返回一个 <a href="https://api.dart.dev/stable/dart-core/Iterable-class.html" target="_blank" rel="noreferrer"><code>Iterable</code></a> 对象.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Iterable&lt;int&gt; genIterates (int max) sync* {</span></span>
